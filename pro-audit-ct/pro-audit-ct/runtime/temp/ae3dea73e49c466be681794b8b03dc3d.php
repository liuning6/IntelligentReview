<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"/var/www/pro-audit-ct/application/view/manager/updatepassword.html";i:1730283939;s:57:"/var/www/pro-audit-ct/application/view/common/header.html";i:1730478573;s:57:"/var/www/pro-audit-ct/application/view/common/footer.html";i:1730283939;}*/ ?>
<!DOCTYPE html>
<html lang="">
<head>
    <meta charset="UTF-8">
...
<div class="contentBox" style="height:auto">
    <div class="whole-bg">
            <div class="login-cent" style="margin:50px auto 0;padding-top:10px;padding-bottom:0;height:390px;">
                <h3 style="height:60px;line-height:60px;font-weight:bold">修改密码: <?php echo \think\Session::get('user.username'); ?> <?php echo \think\Session::get('suser.mobile'); ?></h3>
    ...
    function qr() {
       var password = $("#password").val();
        ...
        $.ajax({
            ...
            success:function (re) {
                alert(re["msg"]);
				if(re['code'] == 1)top.location.href='<?php echo U('login'); ?>';
            }
        })
    }
